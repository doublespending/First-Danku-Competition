...
contract Danku {
  ...
  // train_datay & test_data are not public
  ...
  function init3(int256[] _train_data_groups, int256 _train_data_group_nonces) external {
    // _train_data_groups is just a partition_size train_data
    ...
    // Wait until all training data groups have been revealed
  ...
  function get_submission_id(
    ...
    // Reveal test_data_groups one by one too.
    // Verify data group and nonce lengths
  ...
  function evaluate_model(uint submission_index) public {
    // Submitters must call evaluate_model by themselves.
    ...
    } else { // if test data has not been reveal, use train data.
  ...
  function finalize_contract() public {
    ...
    // best_submission_accuracy must over the model_accuracy_criteria
...
///////////////////////////////////////////////////2018/3/26///////////////////////////////////////////////////////////////////
  ...
  function randomly_select_index(uint[] array) private {
    ...
    uint block_i = 0;
    // Randomly select indexes as training set.
    ...
    // Unselected indexes are testing set.
    t_index = 0;
